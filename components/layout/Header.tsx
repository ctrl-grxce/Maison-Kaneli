...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-sand-deep/70 bg-ivory/85 backdrop-blur-md">
      ...
      <div
        className={cn(
          "fixed inset-0 z-50 flex flex-col bg-ivory transition-opacity duration-500 lg:hidden",
      ...
      >
        ...
        <nav aria-label="Menu mobile" className="flex flex-1 flex-col justify-center px-8">
        ...
        <div className="flex items-center justify-between border-t border-sand-deep px-8 py-5 text-[0.68rem] tracking-[0.16em] text-taupe uppercase">
